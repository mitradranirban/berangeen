...
FONT_PATH = "fonts/ttf/Berangeen-Bold.ttf"
FONT_LICENSE = "OFL v1.1"
AUXILIARY_FONT = "Helvetica"
AUXILIARY_FONT_SIZE = 48

LINE_ONE = "ABCDEFGHIJKLMNOPQRSTUVWXYZ,.;:!@#$%^&*(){}"
LINE_TWO = "abcdefghijklmnopqrstuvwxyz[]123456789"
LINE_THREE = "অআইঈউঊঋএঐওঔকখগঘঙচছজঝঞটঠডঢণ"
LINE_FOUR = "তথদধনপফবভমযরলশষসহংঃঁ১২৩৪৫৬৭৮৯০"
